...
class NTFYClient():
    ...
    def send_message(self, message: NTFYPushMessage):
        ...
        self.send(message.message, title=message.title, priority=priority, tags=tags, click=message.click_url, attach=attachment, actions=actions, email=message.email, delay=message.delay, icon=message.icon_url)
